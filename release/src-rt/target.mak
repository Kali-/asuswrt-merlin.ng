...
export RT-AC68U_BASE := IPV6SUPP=y HTTPS=y ARM=y BCM57=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y \
			...
			TFAT=y HFS="tuxera" NTFS="tuxera" REPEATER=y DUALWAN=y DNSFILTER=y UPNPIGD2=n \
			DNSSEC=y NANO=y OPENSSL11=y NTPD=y DNSPRIVACY=y LETSENCRYPT=y UTF8_SSID=y NETOOL=y TRACEROUTE=n
...
export DSL-AC68U += BUILD_NAME="DSL-AC68U" DSL=y DSL_TCLINUX=y VDSL=y BTN_WPS_ALLLED=y TCPDUMP=y BCM4352_5G=y
